...
<script type="text/javascript" src="/board/assets/js/board.js"></script>
<script>
	// 댓글 수정
...
<%-- 			<tr>
			...
			<tr>
				<th>내용</th>
				<td colspan="3"><c:if test="${not empty board.image}"><img src="board/images/thumbs/${board.image }"></c:if><pre style="white-space: pre-wrap;">${board.content }</pre></td>
			</tr>
		</table>
		<br><br>
		 	<c:choose>
		...
		<input class="button" type="submit" value="게시글 리스트" onclick="location.href='BoardServlet?command=board_list&currPage=${currPage}&searchType=${searchVO.searchType }&searchText=${searchVO.searchText }'">
	</div>
	<br><br>
	<div id="comment">
