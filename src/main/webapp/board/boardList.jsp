            ...
            <div class="user" align="right">
					 <c:choose>
						<c:when test="${not empty userId}">
								 <span><a class ="color" href="memberUpdate?command=viewForm&userId=${userId }"><%=session.getAttribute("nick") %></a>님 안녕하세요.</span>
                        
                       			 <span><a class ="color" href="BoardServlet?command=logout">로그아웃</a></span>
                 		 </c:when>
						<c:otherwise>
        ...
        <section class="ops">
            <div class="inner">
                <div id="wrap" align="center">
					...
					<h1 style="color:#19B5FE; font-size:40px; " onclick="location.reload()">모두의 레시피</h1>
					<table>
						<tr>
								<c:choose>
									<c:when test="${not empty userId}">
							...
							<td style="border:white; text-align:right">
								...
								<input type="hidden" name="currPage" value="${pageHandler.currPage }">
									<select class="orderby" name="filterType" style ="text-align: left">
